                    ...
                    <form class="user" method="post" action="{{ route('register') }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="custom-control custom-checkbox small">
                            <input type="checkbox" name="add_user" class="custom-control-input" id="customCheck"
                            {{ old('add_user') ? 'checked' : '' }}>
                            <label class="custom-control-label" for="customCheck">Manage Users </label>
                          </div>
                        </div>
